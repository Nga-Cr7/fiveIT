...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchTotalUserByMonth = async () => {
      try {
        const baseUrl =
          `http://localhost:8080/auth/admin/getQuantityUserByMonth?year=${year}`;
        const response = await fetch(baseUrl, {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`, // Replace with your actual authorization token
  ...
  // ];
  // const xLabels = data.map((item) => item.group);
  ...
  return (
    <>
        ...
        <div className="row g-4">
          <div className="col-sm-6 col-xl-3">
            ...
            <div className="bg-light rounded d-flex align-items-center justify-content-between p-4">
              ...
              <div className="ms-3">
                <p className="mb-2">{t('dashboard.totalCandidate')}</p>
          ...
          <div className="col-sm-6 col-xl-3">
            ...
            <div className="bg-light rounded d-flex align-items-center justify-content-between p-4">
              ...
              <div className="ms-3">
                <p className="mb-2">{t('dashboard.employer')}</p>
          ...
          <div className="col-sm-6 col-xl-2">
            ...
            <div className="bg-light rounded d-flex align-items-center justify-content-between p-4">
              ...
              <div className="ms-3">
                <p className="mb-2">{t('dashboard.jobs')}</p>
          ...
          <div className="col-sm-6 col-xl-2">
            ...
            <div className="bg-light rounded d-flex align-items-center justify-content-between p-4">
              ...
              <div className="ms-3">
                <p className="mb-2">{t('dashboard.blogs')}</p>
          ...
          <div className="col-sm-6 col-xl-2">
            ...
            <div className="bg-light rounded d-flex align-items-center justify-content-between p-4">
              ...
              <div className="ms-3">
                <p className="mb-2">{t('dashboard.contacts')}</p>
          ...
          <div className="col-sm-12 col-xl-12">
            <div className="bg-light text-center rounded p-4">
              <div className="d-flex align-items-center justify-content-between mb-4">
                <h6 className="mb-0">{t('dashboard.statistics')}</h6>
                <div className="col-3">
                 <select
                  className="form-control"
                  id="selectMonth"
      ...
      <div className="container-fluid pt-4 px-4 pb-5">
        <div className="bg-light text-center rounded p-4">
          <div className="d-flex align-items-center justify-content-between mb-4">
            <h6 className="mb-0">{t('Recent Employer')}</h6>
          </div>
